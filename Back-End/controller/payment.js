...
exports.createOrder = async (req, res) => {
  const { amount, country, visaId, email, phone, selectedDate, travellers, paymentType = "online", paymentMethod = "razorpay", payLaterDetails = null, cashDetails = null } = req.body
...
exports.createCashOrder = async (req, res) => {
  try {
    const { amount, country, visaId, email, phone, selectedDate, travellers, cashDetails } = req.body
...
exports.createPayLaterOrder = async (req, res) => {
  try {
    const { amount, country, visaId, email, phone, selectedDate, travellers, payLaterDetails } = req.body
