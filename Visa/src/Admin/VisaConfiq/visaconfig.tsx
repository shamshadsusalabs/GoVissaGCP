...
const VisaConfigForm: React.FC = () => {
  ...
  const saveConfigurations = async () => {
    try {
      ...
      const response = await fetch("https://govisaa-872569311567.asia-south2.run.app/api/configurations/add", {
        method: "POST",
        headers: {
          ...
          <div className="bg-gray-100 px-6 py-4 flex justify-between items-center border-b">
            <div>
              <h2 className="text-xl font-semibold text-gray-800 flex items-center gap-2">
                {country.country}
                {country.countryCode && (
                  <span className="text-sm bg-gray-200 text-gray-700 px-2 py-1 rounded">{country.countryCode}</span>
                )}
              </h2>
            ...
            <div className="flex gap-2">
              ...
              <button onClick={() => removeCountry(country.id)} className="text-red-600 hover:text-red-800 p-2">
                <FaTrash />
              </button>
            </div>
          </div>
                        ...
                        <div className="bg-green-50 p-3 rounded">
                          ...
                          <p className="font-medium">
                            {visaType.details.visaFee
                              ? `${visaType.details.currency} ${visaType.details.visaFee.toFixed(2)}`
                              : "Not specified"}
                          </p>
                        </div>
                        ...
                        <div className="bg-red-50 p-3 rounded">
                          ...
                          <p className="font-medium">
                            {visaType.details.serviceFee
                              ? `${visaType.details.currency} ${visaType.details.serviceFee.toFixed(2)}`
                              : "Not specified"}
                          </p>
                        </div>
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setVisaDetails({ ...visaDetails, visaFee: Number.parseFloat(e.target.value) || 0 })
                        }
                        placeholder="Amount"
                  ...
                  <div>
                    ...
                    <div className="flex">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setVisaDetails({ ...visaDetails, serviceFee: Number.parseFloat(e.target.value) || 0 })
                        }
                        placeholder="Amount"
                        className="flex-1 p-2 border-t border-b border-r border-gray-300 rounded-r focus:ring-2 focus:ring-blue-500"
                        min="0"
