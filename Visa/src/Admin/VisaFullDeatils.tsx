          ...
          <div className="p-6">
            ...
            {activeTab === "details" && (
              <div className="space-y-8">
                ...
                {(application.promoCode || application.discountAmount || application.originalAmount) && (
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                      <CreditCard className="w-5 h-5 mr-2 text-green-600" />
                      Promo Code Information
                    </h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-green-50 p-6 rounded-xl border border-green-200">
                      {application.promoCode && (
                        <InfoItem
                          icon={<FileText className="w-4 h-4 text-green-600" />}
                          label="Promo Code"
                          value={application.promoCode}
                        />
                      )}
                      {application.originalAmount && (
                        <InfoItem
                          ...
                          value={`₹${application.originalAmount}`}
                        />
                      )}
                      {application.discountAmount && (
                        <InfoItem
                          ...
                          value={`−₹${application.discountAmount}`}
                        />
                      )}
                      {application.originalAmount && application.discountAmount && (
                        <InfoItem
                          icon={<CreditCard className="w-4 h-4 text-green-600" />}
                          label="Final Amount"
                          value={`₹${(Number(application.originalAmount) - Number(application.discountAmount)).toFixed(2)}`}
                        />
                      )}
                    </div>
                  </div>
