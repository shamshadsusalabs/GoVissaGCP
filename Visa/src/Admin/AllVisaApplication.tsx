...
const AllVisaApplication: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("https://govisaagcp-583006320489.asia-south2.run.app/api/VisaApplication/GetAll")
  ...
  const fetchEmployees = async () => {
    ...
    try {
      const response = await fetch("https://govisaagcp-583006320489.asia-south2.run.app/api/employee/getAll")
  ...
  const handleStatusChange = async () => {
    ...
    try {
      const response = await fetch(
        `https://govisaagcp-583006320489.asia-south2.run.app/api/VisaApplication/visa-status/${selectedApp._id}`,
        {
          method: "POST",
  ...
  const handleAssignEmployee = async (employeeId: string) => {
    ...
    try {
      const response = await fetch(`https://govisaagcp-583006320489.asia-south2.run.app/api/employee/addVisaId/${employeeId}/add-visa`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
