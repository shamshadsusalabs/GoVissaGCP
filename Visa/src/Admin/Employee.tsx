...
const EmployeeManagement = () => {
  ...
  useEffect(() => {
    const filtered = employees.filter((employee) => {
      ...
      return name.includes(searchLower) || email.includes(searchLower) || phoneNumber.includes(searchTerm) || employeeId.includes(searchLower)
    })
          ...
          <TableBody>
            {filteredEmployees.map((employee) => (
              <TableRow key={employee._id} hover>
                ...
                <TableCell>
                  <Chip label={employee.employeeId} variant="outlined" size="small" />
                </TableCell>
        ...
        <form onSubmit={handleCreateEmployee}>
          <DialogContent>
            <DialogContentText sx={{ mb: 2 }}>
              Add a new employee to the system. Please provide a unique employee ID.
            </DialogContentText>
            <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
              ...
              <TextField
                ...
                required
                fullWidth
                helperText="Enter a unique employee ID for this employee"
              />
              <TextField
                label="Email"
                type="email"
