...
const CouponCode: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      const response = await fetch(`https://govissa-872569311567.asia-south2.run.app/api/promocode/${id}`, {
        method: 'DELETE'
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      let response;
      if (currentPromo) {
        response = await fetch(`https://govissa-872569311567.asia-south2.run.app/api/promocode/${currentPromo._id}`, {
          method: 'PUT',
          headers: {
        ...
        response = await fetch('https://govissa-872569311567.asia-south2.run.app/api/promocode/add', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
