...
const ManagerManagement = () => {
  ...
  const fetchManagers = async () => {
    try {
      const response = await fetch("https://govissa-872569311567.asia-south2.run.app/api/manager/GetAll")
      if (!response.ok) {
  ...
  const handleCreateManager = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://govissa-872569311567.asia-south2.run.app/api/manager/signup", {
        method: "POST",
        headers: {
  ...
  const handleUpdateManager = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch(`https://govissa-872569311567.asia-south2.run.app/api/manager/updateById/${editingManager._id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteManager = async () => {
    ...
    try {
      const response = await fetch(`https://govissa-872569311567.asia-south2.run.app/api/manager/deleteByID/${deletingManager._id}`, {
        method: "DELETE",
      })
  ...
  const handleVerifyManager = async (id: string, currentStatus: boolean) => {
    setVerifyingId(id)
    try {
      const response = await fetch(`https://govissa-872569311567.asia-south2.run.app/api/manager/verify/${id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
        },
