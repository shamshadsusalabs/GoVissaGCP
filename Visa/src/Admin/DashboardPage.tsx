  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true)
        // Fetch stats
        const statsResponse = await fetch("https://govissa-872569311567.asia-south2.run.app/api/VisaApplication/stats")
        if (!statsResponse.ok) {
        ...
        const recentResponse = await fetch("https://govissa-872569311567.asia-south2.run.app/api/VisaApplication/getLatest")
        ...
        const visaTypesResponse = await fetch("https://govissa-872569311567.asia-south2.run.app/api/configurations/counts/types")
