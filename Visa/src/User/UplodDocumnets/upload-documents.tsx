...
export default function UploadDocuments() {
  ...
  const handleProcessingModeSelect = (mode: "online" | "offline", empId?: string) => {
    ...
    console.log("🔧 Processing Mode Selected:", { mode, employeeId: empId })
  }
  ...
  const handleFileChange = async (file: File | null) => {
    ...
    if (isPassportName(currentDoc.name) && currentSide === "front") {
      ...
      try {
        ...
        console.log("🤖 OCR Data Received:", ocrResponse)
  ...
  const handleSubmitApplication = async () => {
    ...
    try {
      ...
      // ✅ NOTE: Promo code data will be automatically fetched by backend from payment order using paymentId
      console.log("🔍 Backend will automatically fetch promo code data from payment order using paymentId:", paymentId)
      ...
      console.log("📝 Note: Promo code data will be fetched automatically by backend from payment order")
