...
export default function PaymentHistory() {
  ...
  const checkDocumentStatus = async (paymentId: string) => {
    ...
    try {
      ...
      const response = await fetch(`https://govisaagcp-583006320489.asia-south2.run.app/api/VisaApplication/getbyPaymentID/${paymentId}`)
  ...
  useEffect(() => {
    const fetchPayments = async () => {
      try {
        ...
        const response = await fetch(`https://govisaagcp-583006320489.asia-south2.run.app/api/payments/by-phone/${phoneNumber}`)
