    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <div className="bg-white rounded-lg shadow-md p-6 sm:p-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Govisaa Privacy Policy</h1>
        ...
        <div className="prose prose-blue max-w-none">
          <p className="text-gray-700 mb-6 leading-relaxed">
            At Govisaa, we value your privacy. We collect only necessary personal data to process visa applications, such as name, passport number, travel dates, and contact details.
          </p>
          ...
          <div className="bg-blue-50 rounded-lg p-4 mt-8">
            <p className="text-blue-800 text-center">
              ...
              <a href="mailto:privacy@govisaa.com" className="font-semibold hover:underline">
                privacy@govisaa.com
              </a>
            </p>
          </div>
